 ...
 <fieldset style="width:60%"><legend>update Product</legend>
	 <form action="vehicleupdateservlet" method="post">
	   ...
	   <tr>
	      ...
	      <tr>
	      <td>Vehicle_Type</td>
	      <td><input  value="<%=product.getVehicleType() %>"  name="vehicle_type" autofocus="autofocus" required="required"></td>
	      </tr>
	      ...
	      <tr>
	      <td>Capacity</td>
	      <td><input  value="<%=product.getVehicleCapacity() %>"  name="Capacity" required="required"></td>
	      </tr>
	      ...
	      <td><input  value="<%=product.getVehicleCost() %>"  name="cost" required="required"></td>
	       ...
	       <tr>
		      ...
		      <input type="submit" value="update vehicle"></td>
	      </tr>
